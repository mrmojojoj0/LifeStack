...
public class TodoPanel extends BaseAppPanel {
    ...
    private File currentFile; // track CSV file
    ...
    private void addSaveAction(JButton saveBtn) {
        saveBtn.addActionListener(e -> {
            ...
            try (BufferedWriter writer = new BufferedWriter(new FileWriter(currentFile))) {
                ...
                logLabel.setText("Saved tasks to " + currentFile.getName());
            } catch (Exception ex) {
    ...
    private void addLoadAction(JButton loadBtn) {
        loadBtn.addActionListener(e -> {
            ...
            try (BufferedReader reader = new BufferedReader(new FileReader(currentFile))) {
                ...
                logLabel.setText("Loaded tasks from " + currentFile.getName());
            } catch (Exception ex) {
                logLabel.setText("Error loading tasks!");
                JOptionPane.showMessageDialog(parentFrame, "Error loading tasks!", "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
    }
